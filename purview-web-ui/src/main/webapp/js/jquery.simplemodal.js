...
;(function ($) {
	 ...
	 * transient_:		(Boolean:false) If true, the overlay, iframe, and certain events will be disabled
	...
	$.modal.impl = {
		...
		create: function (data) {
			...
			s.d.overlay = $('<div></div>')
				...
				.css($.extend(s.o.overlayCss, {
					...
					height: s.o.transient_ ? 0 : w[0],
					width: s.o.transient_ ? 0 : w[1],
					position: 'fixed',
					left: 0,
					top: 0,
					zIndex: s.o.zIndex + 1
		...
		bindEvents: function () {
			...
			if (!s.o.transient_ && s.o.close && s.o.overlayClose) {
			...
			$(document).bind('keydown.simplemodal', function (e) {
				if (!s.o.transient_ && s.o.focus && e.keyCode == 9) { // TAB
					s.watchTab(e);
				}
		...
		fixIE: function () {
			...
			$.each([s.d.iframe || null, s.o.transient_ ? null : s.d.overlay, s.d.container], function (i, el) {
				if (el) {
